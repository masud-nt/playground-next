...
import { SwitchChild } from "../Switch/switch";
...
const ParentLayout: FC<ParentLayoutProps> = ({
  items,
  children,
  LinkRenderer = (props: LinkRendererProps) => <a {...props} />,
  logo,
            ...
            <div className="flex flex-1 gap-x-4 self-stretch justify-end lg:gap-x-6">
              <div className="flex items-center gap-x-4 lg:gap-x-6">
                <Menu as="div" className="relative">
                  <Menu.Button className="-m-1.5 flex items-center p-1.5 max-w-[200px]">
                  ...
                  >
                    <Menu.Items className="absolute right-0 z-10 mt-2.5 min-w-[160px] origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                      <Menu.Item disabled>
                        <div className="flex flex-col space-y-1 px-3 pb-2 mb-1 border-b">
